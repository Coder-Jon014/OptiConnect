                    ...
                    <div className="mt-4">
                        ...
                        <table className="min-w-full bg-white dark:bg-gray-800">
                            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                                <tr>
                                    <th onClick={() => sortChanged('customer_id')} className="py-2 px-4 border-b border-gray-200 dark:border-gray-700 cursor-pointer">Customer ID</th>
                                    <th onClick={() => sortChanged('customer_name')} className="py-2 px-4 border-b border-gray-200 dark:border-gray-700 cursor-pointer">Name</th>
                                    <th className="py-2 px-4 border-b border-gray-200 dark:border-gray-700">Phone</th>
                                    <th onClick={() => sortChanged('town')} className="py-2 px-4 border-b border-gray-200 dark:border-gray-700 cursor-pointer">Town</th>
                                    <th onClick={() => sortChanged('customer_type')} className="py-2 px-4 border-b border-gray-200 dark:border-gray-700 cursor-pointer">Customer Type</th>
                                </tr>
                            </thead>
                            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                                <tr>
