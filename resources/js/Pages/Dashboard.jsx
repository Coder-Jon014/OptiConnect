    ...
    return (
        ...
        >
            ...
            <div className="container">
                <div className="OLT-Breakdown bg-white dark:bg-red">
                    {/* OLT Breakdown content goes here */}
                    OLT Breakdown                    
                </div>
                <div className="Refund-Amount">
                    {/* Refund Amount content goes here */}
                    Refund Amount
                </div>
                <div className="MapComponent">
                    {/* MapComponent content goes here */}
                    Mapcomponent
                </div>
                <div className="Teams">
                ...
                <div className="List-Of-Recent-Outages">
                    {/* List Of Recent Outages content goes here */}
...
//                         <tr key={index} className="text-customBlue text-center">
